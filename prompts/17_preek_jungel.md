...
```json
{
  ...
  "preek_onderdelen": {
    "deel_1_opening": {
      "titel": "De Provocatie",
      "inhoud": "string - 300-400 woorden. Directe aanspraak, openingsprovocatie, probleemstelling."
    },
    "deel_2_verdieping": {
      "titel": "De Spanning",
      "inhoud": "string - 400-500 woorden. Exegetische verdieping en theologische spanning (menselijk streven vs. Gods toewending)."
    },
    "deel_3_doorbraak": {
      "titel": "Het Geheim",
      "inhoud": "string - 400-500 woorden. Evangelische doorbraak, het 'ja' van God, het kruis als venster."
    },
    "deel_4_toepassing": {
      "titel": "Het Leven Nu",
      "inhoud": "string - 300-400 woorden. Concrete toepassing, bevrijding van prestatiedwang, vreugde."
    },
    "deel_5_afsluiting": {
      "titel": "Zegen",
